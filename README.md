...
This script uses the lm_sensors command to retrieve temperature info from the device. It has been tailored for the output of the command executed on an Intel(R) Xeon(R) E-2174G CPU, so it may not work for your device without proper changes to the code
